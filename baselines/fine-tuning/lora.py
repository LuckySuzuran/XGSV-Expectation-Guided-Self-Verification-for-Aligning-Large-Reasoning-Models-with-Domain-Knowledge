...
# LoRA configuration (recommended to use LLaMA-style)
lora_config = LoraConfig(
    task_type=TaskType.CAUSAL_LM,  # Autoregressive generation task
    r=8,  # Rank value (recommended range: 4~16)
    lora_alpha=16,
    lora_dropout=0.05,
    target_modules=["q_proj", "v_proj"],  # Target modules (confirm for Qwen structure)
    bias="none"
)
